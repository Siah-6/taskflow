...
function Sidebar({ onCreateProject, isMobile, onMobileClose }) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`fixed left-0 top-0 h-screen bg-white flex flex-col border-r border-gray-200 z-50 transition-transform duration-300 md:translate-x-0 ${
        isMobile ? 'translate-x-0 w-64' : '-translate-x-full md:translate-x-0 md:w-64'
      }`}>
        {/* Mobile Close Button */}
          ...
          <div className="mt-8">
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className="w-6 h-6 flex items-center justify-center bg-[#6F00FF] hover:bg-[#5a00cc] text-white rounded-lg font-medium transition-colors"
